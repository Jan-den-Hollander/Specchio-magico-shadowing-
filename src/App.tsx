...
export default function App() {
  ...
  const toggleCam = async () => {
    if (isCamOn) {
      ...
      try {
        ...
        setStatus('Toegang tot camera mislukt.');
        setIsCamOn(false);
      }
    }
  };
  ...
  const speakIt = async (text: string) => {
    ...
    try {
      ...
      utterance.lang = 'it-IT'; utterance.rate = 0.85;
  ...
  const processHeard = async (heard: string) => {
    ...
    const userMsg: Message = { role: 'user', it: heard, nl: '', heard: heard, score: currentScore };
  ...
  return (
    <div className="h-[100dvh] w-full bg-[#080810] text-[#f5f0e8] font-sans selection:bg-[#c9a84c]/30 overflow-hidden flex flex-col">
      <div className="flex flex-col h-full max-w-md mx-auto w-full px-4 pt-3 pb-2 relative z-10">
        ...
        {/* 2. Mirror Section - Bovenaan vast */}
        ...
        {/* 4. Action Row - Microfoon BOVEN de chat */}
        ...
        {/* 5. Chat Area - Helemaal onderaan met scroll */}
